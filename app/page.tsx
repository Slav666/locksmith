  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-10 items-center">
        <div>
          ...
          <p className="text-slate-300 mt-6 text-lg">
            Emergency house lockouts, car unlocking and lock changes. Friendly
            local service, available when you need it most.
          </p>
      ...
      <section className="bg-slate-900 py-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-slate-300 leading-relaxed">
            I’m a local locksmith based around Edinburgh. I’m currently building
            my service and helping people with emergency lockouts, car unlocking
            and basic lock repairs. My focus is fast response, fair prices and
      ...
      <section className="max-w-6xl mx-auto px-6 py-16">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-slate-800 p-6 rounded-3xl">🚪 House Lockouts</div>

          <div className="bg-slate-800 p-6 rounded-3xl">🚗 Car Unlocking</div>

          <div className="bg-slate-800 p-6 rounded-3xl">🔐 Lock Changes</div>
        </div>
      </section>
      ...
      <section className="bg-slate-900 py-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <ul className="space-y-3 text-slate-300">
            <li>✓ Local service in Edinburgh area</li>
            <li>✓ Fast response when available</li>
            <li>✓ Fair and honest pricing</li>
            <li>✓ Friendly and reliable help</li>
          </ul>
        </div>
      </section>
      ...
      <section className="text-center py-20 px-6">
        <h2 className="text-4xl font-bold mb-6">Need Help Now?</h2>

        <p className="text-slate-300 mb-8">Call or message anytime</p>
